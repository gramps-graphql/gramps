...
<AnchorLinks>
  <AnchorLink>Modify the Class Name and Remove the Example Method</AnchorLink>
  <AnchorLink>Write Helper Methods</AnchorLink>
  <AnchorLink>Write a Data Access Method</AnchorLink>
  <AnchorLink>Write Tests for the Model</AnchorLink>
</AnchorLinks>
...
Finally, let’s make sure we get a `GrampsError` if the request fails:
