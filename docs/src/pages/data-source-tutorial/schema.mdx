...
At this point, we’ve [set up a connector](/data-source-tutorial/connector) to tell our data source where data comes from, and [defined data access methods in a model](/data-source-tutorial/model) to make requests for specific types of data. In this section, we’ll create a GraphQL schema to describe our data.
...
<AnchorLinks>
  <AnchorLink>Remove the Example Query and Type</AnchorLink>
  <AnchorLink>Extend the Query Type</AnchorLink>
  <AnchorLink>Define an Input Type</AnchorLink>
  <AnchorLink>Define Field Types</AnchorLink>
</AnchorLinks>
