...
Now that we’ve [set up the data source](/data-source-tutorial/setup), we can start building the data source itself. In this section, we’ll tell the data source where data should come from.
...
<AnchorLinks>
  <AnchorLink>Create Your Connector</AnchorLink>
  <AnchorLink>Write Tests for the Connector</AnchorLink>
</AnchorLinks>
