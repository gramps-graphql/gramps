...
<AnchorLinks>
  <AnchorLink>Install the Data Source Base</AnchorLink>
  <AnchorLink>Update the Context Name for the Data Source</AnchorLink>
  <AnchorLink>Update package.json</AnchorLink>
  <AnchorLink>Update the README</AnchorLink>
</AnchorLinks>
...
> **NOTE:** We use [Yarn](https://yarnpkg.com) because it’s currently better than npm at creating
